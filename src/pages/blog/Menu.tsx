...
export default function Menu( {setTableOpen, largeScreen} : MenuProps ) {
  ...
  return (
    <>
      <div className={largeScreen ? 'flex-shrink-0 border-r-4 border-zinc-900 bg-zinc-800 h-screen w-20 text-sm flex flex-col p-2 items-center justify-between' : 'border-b-2 border-zinc-800 bg-darkmetal w-screen h-10 text-sm sticky top-0 left-0 flex flex-row justify-between items-center'}>
        ...
        <span className="lg:border-t-4 border-zinc-700 lg:pt-3"><a href='anya-gh.github.io/portfolio'><img alt='logo' src={logo} className='h-7 pr-2 lg:h-auto'/></a></span>
      </div>
    </>
  )
}